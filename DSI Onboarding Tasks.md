...
That’s why you’re doing these assignments in the first place - so that you can get up to speed! We’ll be reviewing these concepts in the first week as well so if you don’t get it now, you’ll have a chance to fully catch up by the end of the first week of class. 
         ...
         “Why are some parts optional and some required?”

We know you’re busy people. We realize that some of you may be in a full-time job all the way up to the start of the course so we wanted to give you the option of prioritizing your time. If push comes to shove, we want you to do the python and stats modules first. 
### A NOTE ABOUT REQUIREMENTS
*“Optional”* doesn't mean "don’t do it," it means: "*if you are time constrained and can only do one thing to prepare for class, complete the* ***required modules on Python & Stats.***" Remember, the more that you can prepare for the first day of class, the better off you’ll be! 
...
Additionally, before the course starts, we’ll invite you to campus to get your computer setup with the following technologies:
...
Feel free to start getting familiarized with what these technologies are ahead of time but there’s no need to install anything, we’ll do that with you!
...
## STEP 2: COMPLETE THESE OPTIONAL MODULES
5 - 10 hrs

If you’ve sped through Step 1, the best thing for you to do is to get familiar with Git, SQL, and the command line. Try to get through *each* of these tutorials before moving on to Step 3:
...
## STEP 3: SUBMIT THESE REQUIRED EXERCISES 
1 -2 hrs

Once you've completed Steps 1 and 2, please complete our **[Data Science Onboarding Exercises](https://mobilega.typeform.com/to/SOC7S7)**. Follow the directions to submit your answers. 


## STEP 4: TRY SOME OPTIONAL BONUS MATERIALS 
1 hr - however long you want!

Up for a challenge? These advanced exercises will help you sharpen your mathematical and programming wits: 
...
## STEP 5: DO SOME OPTIONAL READING
1 hr - however long you want!
